...
{
    public class UsuariosEmpleadoController : Controller
    {
        private readonly PruebaTecnicaDbContext _context;

        public UsuariosEmpleadoController(PruebaTecnicaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Usuarios != null ?
                        View(await _context.Usuarios.Include(d => d.ObDepartamento).Where(p => p.Tipo.Contains("empleado")).ToListAsync()) :
