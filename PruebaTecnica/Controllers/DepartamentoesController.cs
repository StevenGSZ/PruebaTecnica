...
namespace PruebaTecnica.Controllers
{
    public class DepartamentoesController : Controller
    {
        ...
        public DepartamentoesController(PruebaTecnicaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departamentos != null ? 
                          ...
                          Problem("Entity set 'PruebaTecnicaDbContext.Departamentos'  is null.");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PruebaTecnicaDbContext.Departamentos'  is null.");
            }
            var departamento = await _context.Departamentos.FindAsync(id);
            if (departamento != null)
            {
